...
export function Card({post}: ICardProps) {
  ...
  return (
    <div className={styles.card}>
      <CardTextContent content={post.textContent}/>
      <div className={styles.preview}>
        <img
          src={post.image ? post.image : 'https://skillz4kidzmartialarts.com/wp-content/uploads/2017/04/default-image-620x600.jpg'}
          className={styles.previewImg} alt=""/>
      </div>
      <CardMenu/>
      <CardControls>
